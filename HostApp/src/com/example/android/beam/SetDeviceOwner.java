...
public class SetDeviceOwner extends Activity implements
    ...
    public NdefMessage createNdefMessage(NfcEvent event) {
        ...
        try {
            ...
            p.setProperty(DevicePolicyManager.EXTRA_PROVISIONING_EMAIL_ADDRESS,
                    "test@tonoi.co.jp");
            /****************
            ...
            p.setProperty(DevicePolicyManager.EXTRA_PROVISIONING_WIFI_PASSWORD,
                    "09090080122");
            p.setProperty(DevicePolicyManager.EXTRA_PROVISIONING_WIFI_SECURITY_TYPE,
                    "WPA2");
            *****************/
            p.setProperty(DevicePolicyManager.EXTRA_PROVISIONING_LOCALE,
                    "ja_JP");
